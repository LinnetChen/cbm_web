  ...
  <div class="wrap">
    ...
    <div class="pop" v-if="this.pop == true">
      ...
      <ul class="notice">
        ...
        <li>
          官方將保留變更活動內容以及核准兌換與否之權利，詳細活動規則、獎勵及異動說明均以網站或FB粉絲團公告的最後一次公佈為準，請玩家密切留意網站公告訊息。活動開始後，所有玩家視同同意最後公告之內容。
        </li>
      </ul>
    </div>

    <div class="videoBox" v-if="this.videOpen == true" @click="closeVideo()">
      <iframe
        id="player"
        type="text/html"
        width="600"
        ...
        <div class="stepWrap">
            ...
            <div class="stepBoxWrap" data-aos="fade-up">
              <form action="" method="post">
                <div class="phoneBox">
                  ...
                  >
                    <!-- <option disabled value="">選擇區碼</option> -->
                ...
                <div class="checkBox">
                  ...
                  <label for="check"
                    >勾選即同意
                    <a href="http://www.digeam.com/terms2" target="_blank"
                      >事前預約相關隱私權條款</a
                    ></label
                  >
                </div>
          ...
          <div class="right stepBox">
            <div class="stepBox2 stepBoxS">
              ...
              >
                <div class="awardBox">
                  <img src="img/prereg/step2Gift.png" alt="" />
                </div>
                <div class="typeBox" v-if="this.user.device == 'PC'">
                  <a
                    href="https://play.google.com/store/apps/details?id=com.estgames.cm.tw"
            ...
            <div class="stepBox3 stepBoxS">
              ...
              >
                <div class="awardBox">
                  <img src="/img/prereg/step3Gift.png" alt="" />
                </div>
                <div class="typeBox">
                  <iframe
      ...
      <section class="sec02">
        <div class="sec02Wrap">
          ...
          <swiper
            ...
            :modules="modules"
          >
            <swiper-slide v-for="(item, idx) in slick02Data" :key="idx">
              <div class="item">
                <img :src="item.img" alt="" class="item_img" />
                <img :src="item.imgM" alt="" class="item_img_m" />
                <div class="item_box">
                  <img
                    :src="item.title"
                    alt="item.titleAlt"
                    class="item_title"
                  />
                  <p v-html="item.content" class="item_content"></p>
                </div>
              </div>
            </swiper-slide>
      ...
      <section class="sec03">
        ...
        <div class="sec03Wrap">
          <swiper
            ...
            class="swiper_char"
          >
            <swiper-slide v-for="(item, idx) in slick03Data" :key="idx">
              <div class="charWrap">
                <div class="char_box">
                  <img :src="item.bgImg" alt="" class="bgImg" />
                  <img :src="item.charImg" alt="" class="charImg" />
                </div>
                <div class="char_info">
                  <div class="info1">
                    <img :src="item.title" alt="" class="titleImg" />
                    <img
                      :src="item.linkImg"
                      alt=""
                      @click="videoId(idx)"
          ...
          <div class="swiper_thumbs">
            <swiper
              ...
              class="swiper_tab"
            >
              <swiper-slide v-for="(item, idx) in slick03tab" :key="idx"
      ...
      <section class="sec04">
        ...
        <div class="sec04Wrap" id="sec04">
          <swiper
            ...
            :modules="modules"
          >
            <swiper-slide v-for="(item, idx) in slick04Data" :key="idx">
              <div class="item">
                <img :src="item.img" alt="" class="item_img" />
              </div>
            </swiper-slide>
    ...
    async resever() {
      ...
      try {
        ...
        res.data.status == 1
          ...
          : res.data.status == -99
          ? ((this.popSmsg = "此號碼已預約！"), (this.user.status = true))
          : res.data.status == -97
          ? (this.popSmsg =
